...
- [analyze-stock.ts](https://github.com/vrife/worldmonitor/blob/main/server/worldmonitor/market/v1/analyze-stock.ts)
- [get-stock-analysis-history.ts](https://github.com/vrife/worldmonitor/blob/main/server/worldmonitor/market/v1/get-stock-analysis-history.ts)
- [backtest-stock.ts](https://github.com/vrife/worldmonitor/blob/main/server/worldmonitor/market/v1/backtest-stock.ts)
- [list-stored-stock-backtests.ts](https://github.com/vrife/worldmonitor/blob/main/server/worldmonitor/market/v1/list-stored-stock-backtests.ts)
- [premium-stock-store.ts](https://github.com/vrife/worldmonitor/blob/main/server/worldmonitor/market/v1/premium-stock-store.ts)

Primary contracts:

- [analyze_stock.proto](https://github.com/vrife/worldmonitor/blob/main/proto/worldmonitor/market/v1/analyze_stock.proto)
- [get_stock_analysis_history.proto](https://github.com/vrife/worldmonitor/blob/main/proto/worldmonitor/market/v1/get_stock_analysis_history.proto)
- [backtest_stock.proto](https://github.com/vrife/worldmonitor/blob/main/proto/worldmonitor/market/v1/backtest_stock.proto)
- [list_stored_stock_backtests.proto](https://github.com/vrife/worldmonitor/blob/main/proto/worldmonitor/market/v1/list_stored_stock_backtests.proto)
- [service.proto](https://github.com/vrife/worldmonitor/blob/main/proto/worldmonitor/market/v1/service.proto)

### Frontend Surfaces

Panels:

- [StockAnalysisPanel.ts](https://github.com/vrife/worldmonitor/blob/main/src/components/StockAnalysisPanel.ts)
- [StockBacktestPanel.ts](https://github.com/vrife/worldmonitor/blob/main/src/components/StockBacktestPanel.ts)
- [DailyMarketBriefPanel.ts](https://github.com/vrife/worldmonitor/blob/main/src/components/DailyMarketBriefPanel.ts)

Services and loading:

- [stock-analysis.ts](https://github.com/vrife/worldmonitor/blob/main/src/services/stock-analysis.ts)
- [stock-analysis-history.ts](https://github.com/vrife/worldmonitor/blob/main/src/services/stock-analysis-history.ts)
- [stock-backtest.ts](https://github.com/vrife/worldmonitor/blob/main/src/services/stock-backtest.ts)
- [daily-market-brief.ts](https://github.com/vrife/worldmonitor/blob/main/src/services/daily-market-brief.ts)
- [data-loader.ts](https://github.com/vrife/worldmonitor/blob/main/src/app/data-loader.ts)
...
- [gateway.ts](https://github.com/vrife/worldmonitor/blob/main/server/gateway.ts)
- [api/_api-key.js](https://github.com/vrife/worldmonitor/blob/main/api/_api-key.js)
...
- the shared LLM provider chain in [llm.ts](https://github.com/vrife/worldmonitor/blob/main/server/_shared/llm.ts)
