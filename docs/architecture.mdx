...
> **Looking for the system reference?** See [`ARCHITECTURE.md`](https://github.com/vrife/worldmonitor/blob/main/ARCHITECTURE.md) for deployment topology, directory layout, caching layers, CI/CD, and contributor how-to guides.
